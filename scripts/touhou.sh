...
if [ $launch == 6 ]; then
    ...
    wine "$BASEDIR/Touhou 7.5 Suimusou ~ Immaterial and Missing Power/th075e.exe"
elif [ $launch == 8 ]; then
    ...
    wine "$BASEDIR/Touhou 9.5 Bunkachou ~ Shoot the Bullet/th095e.exe"
elif [ $launch == 10 ]; then
    ...
    wine "$BASEDIR/Touhou 12.5 Bunkachou ~ Double Spoiler/th125e.exe"
elif [ $launch == 12.8 ]; then
    wine "$BASEDIR/Touhou 12.8 Yousei Daisensou ~ Touhou Sangetsusei/th128e.exe"
elif [ $launch == 13 ]; then
    cd "$BASEDIR/Touhou 13 - Ten Desires"
    wine "$BASEDIR/Touhou 13 - Ten Desires/Touhou13.exe"
elif [ $launch == 13.5 ]; then
    wine "$BASEDIR/Touhou 13.5 Shinkirou ~ Hopeless Masquerade/th135e.exe"
elif [ $launch == 14 ]; then
    ...
    wine "$BASEDIR/Touhou 14.3 Danmaku Amanojaku ~ Impossible Spell Card/th143.exe"
elif [ $launch == 14.5 ]; then
    wine "$BASEDIR/Touhou 14.5 Shinpiroku ~ Urban Legend in Limbo/th145.exe"
elif [ $launch == 15 ]; then
    ...
    wine "$BASEDIR/Touhou 15.5 Hyouibana ~ Antinomy of Common Flowers/th155.exe"
elif [ $launch == 16 ]; then
    ...
    wine "$BASEDIR/Touhou 16.5 Hifuu Nightmare Diary ~ Violet Detector/th165.exe"
elif [ $launch == 17 ]; then
